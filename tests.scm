...
(define xxxtentacion 000)
; expect xxxtentacion

(define dabdab666 (define x 15))
; expect dabdab666
...
(define (ginger garfield) (* garfield 2))
; expect ginger

(define (thebestfunction i am great) (- (+ (* i 2) great) am))
; expect thebestfunction
...
(let ((xoxo 'me) (nni xoxo)) nni)
; expect 5

(define mooo (mu (mmm) (+ mmm y)))
; expect mooo

(define loo (lambda (x y) (mooo (+ x x))))
; expect loo

(loo 5 8)
; expect 18

(define mooo (mu (mmm) (+ mmm x)))
; expect mooo
